...
POMP_Parallel_fork(&omp_rd_307);
#line 140 "lu.c"
#pragma omp parallel POMP_DLIST_00307
{ POMP_Parallel_begin(&omp_rd_307);
#line 141 "lu.c"
{  
...
#line 144 "lu.c"
#pragma omp master
{ POMP_Master_begin(&omp_rd_308);
#line 145 "lu.c"
  nthreads = omp_get_num_threads();
POMP_Master_end(&omp_rd_308); }
#line 146 "lu.c"
#endif                
}
POMP_Barrier_enter(&omp_rd_307);
#pragma omp barrier
POMP_Barrier_exit(&omp_rd_307);
POMP_Parallel_end(&omp_rd_307); }
POMP_Parallel_join(&omp_rd_307);
#line 148 "lu.c"
...
POMP_For_exit(&omp_rd_309);
#line 230 "lu.c"

POMP_For_enter(&omp_rd_310);
#line 231 "lu.c"
#pragma omp for nowait schedule(static)
  for (i = ist; i <= iend; i++) {
    ...
    if (i != ist) {
	while (flag[i-1] == 0) {
POMP_Flush_enter(&omp_rd_311);
#line 237 "lu.c"
#pragma omp flush(flag)
POMP_Flush_exit(&omp_rd_311);
#line 238 "lu.c"
	    ;
	}
    }
    if (i != iend) {
	while (flag[i] == 1) {
POMP_Flush_enter(&omp_rd_312);
#line 243 "lu.c"
#pragma omp flush(flag)
POMP_Flush_exit(&omp_rd_312);
#line 244 "lu.c"
	    ;
	}
    }
...
--------------------------------------------------------------------*/
    ...
    if (i != ist) flag[i-1] = 0;
    if (i != iend) flag[i] = 1;
POMP_Flush_enter(&omp_rd_313);
#line 418 "lu.c"
#pragma omp flush(flag)    
POMP_Flush_exit(&omp_rd_313);
#line 419 "lu.c"
#endif                  
  }
POMP_For_exit(&omp_rd_310);
#line 421 "lu.c"
}
...
POMP_For_exit(&omp_rd_314);
#line 468 "lu.c"

POMP_For_enter(&omp_rd_315);
#line 469 "lu.c"
#pragma omp for nowait schedule(static)
  for (i = iend; i >= ist; i--) {
#if defined(_OPENMP)      
    if (i != iend) {
      while (flag[i+1] == 0) {
POMP_Flush_enter(&omp_rd_316);
#line 474 "lu.c"
#pragma omp flush(flag)
POMP_Flush_exit(&omp_rd_316);
#line 475 "lu.c"
	;
      }
    }
    if (i != ist) {
      while (flag[i] == 1) {
POMP_Flush_enter(&omp_rd_317);
#line 480 "lu.c"
#pragma omp flush(flag)
POMP_Flush_exit(&omp_rd_317);
#line 481 "lu.c"
	;
      }
    }
...
--------------------------------------------------------------------*/
    ...
    if (i != ist) flag[i] = 1;
POMP_Flush_enter(&omp_rd_318);
#line 658 "lu.c"
#pragma omp flush(flag)
POMP_Flush_exit(&omp_rd_318);
#line 659 "lu.c"
#endif                  
  }
POMP_For_exit(&omp_rd_315);
#line 661 "lu.c"
}
...
POMP_Parallel_fork(&omp_rd_319);
#line 712 "lu.c"
#pragma omp parallel POMP_DLIST_00319
{ POMP_Parallel_begin(&omp_rd_319);
#line 713 "lu.c"
{
...
POMP_Barrier_enter(&omp_rd_320);
#pragma omp barrier
POMP_Barrier_exit(&omp_rd_320);
POMP_For_exit(&omp_rd_320);
#line 753 "lu.c"

POMP_For_enter(&omp_rd_321);
#line 754 "lu.c"
#pragma omp for nowait
  for (i = 0; i < nx; i++) {
    iglob = i;
...
POMP_Barrier_enter(&omp_rd_321);
#pragma omp barrier
POMP_Barrier_exit(&omp_rd_321);
POMP_For_exit(&omp_rd_321);
#line 781 "lu.c"
...
POMP_Barrier_enter(&omp_rd_322);
#pragma omp barrier
POMP_Barrier_exit(&omp_rd_322);
POMP_For_exit(&omp_rd_322);
#line 807 "lu.c"

POMP_For_enter(&omp_rd_323);
#line 808 "lu.c"
#pragma omp for nowait
  for (j = jst; j <= jend; j++) {
    for (k = 1; k <= nz - 2; k++) {
...
POMP_Barrier_enter(&omp_rd_323);
#pragma omp barrier
POMP_Barrier_exit(&omp_rd_323);
POMP_For_exit(&omp_rd_323);
#line 912 "lu.c"
...
POMP_Barrier_enter(&omp_rd_324);
#pragma omp barrier
POMP_Barrier_exit(&omp_rd_324);
POMP_For_exit(&omp_rd_324);
#line 938 "lu.c"

POMP_For_enter(&omp_rd_325);
#line 939 "lu.c"
#pragma omp for nowait
  for (i = ist; i <= iend; i++) {
    for (k = 1; k <= nz - 2; k++) {
...
POMP_Barrier_enter(&omp_rd_325);
#pragma omp barrier
POMP_Barrier_exit(&omp_rd_325);
POMP_For_exit(&omp_rd_325);
#line 1045 "lu.c"

/*--------------------------------------------------------------------
c   zeta-direction flux differences
--------------------------------------------------------------------*/
POMP_For_enter(&omp_rd_326);
#line 1049 "lu.c"
#pragma omp for nowait
  for (i = ist; i <= iend; i++) {
    for (j = jst; j <= jend; j++) {
...
POMP_Barrier_enter(&omp_rd_326);
#pragma omp barrier
POMP_Barrier_exit(&omp_rd_326);
POMP_For_exit(&omp_rd_326);
#line 1165 "lu.c"
}
POMP_Barrier_enter(&omp_rd_319);
#pragma omp barrier
POMP_Barrier_exit(&omp_rd_319);
POMP_Parallel_end(&omp_rd_319); }
POMP_Parallel_join(&omp_rd_319);
#line 1166 "lu.c"
}
/*--------------------------------------------------------------------
--------------------------------------------------------------------*/
...
POMP_Parallel_fork(&omp_rd_329);
#line 2000 "lu.c"
#pragma omp parallel  POMP_DLIST_00329
{ POMP_Parallel_begin(&omp_rd_329);
#line 2001 "lu.c"
{
...
POMP_Single_enter(&omp_rd_330);
#line 2013 "lu.c"
#pragma omp single   nowait
{ POMP_Single_begin(&omp_rd_330);
#line 2014 "lu.c"
  for (m = 0; m < 5; m++) {
    sum[m] = 0.0;
  }
POMP_Single_end(&omp_rd_330); }
POMP_Barrier_enter(&omp_rd_330);
#pragma omp barrier
POMP_Barrier_exit(&omp_rd_330);
POMP_Single_exit(&omp_rd_330);
#line 2017 "lu.c"

POMP_For_enter(&omp_rd_331);
#line 2018 "lu.c"
#pragma omp for nowait
  for (i = ist; i <= iend; i++) {
    for (j = jst; j <= jend; j++) {
...
POMP_For_exit(&omp_rd_331);
#line 2030 "lu.c"

POMP_Critical_enter(&omp_rd_332);
#line 2031 "lu.c"
#pragma omp critical
{ POMP_Critical_begin(&omp_rd_332);
#line 2032 "lu.c"
  {
      sum[0] += sum0;
      sum[1] += sum1;
...
POMP_Critical_end(&omp_rd_332); }
POMP_Critical_exit(&omp_rd_332);
#line 2039 "lu.c"
POMP_Barrier_enter(&omp_rd_333);
#line 2039 "lu.c"
#pragma omp barrier  
POMP_Barrier_exit(&omp_rd_333);
#line 2040 "lu.c"
  
POMP_Single_enter(&omp_rd_334);
#line 2041 "lu.c"
#pragma omp single   nowait
{ POMP_Single_begin(&omp_rd_334);
#line 2042 "lu.c"
  for (m = 0;  m < 5; m++) {
    sum[m] = sqrt ( sum[m] / ( (nx0-2)*(ny0-2)*(nz0-2) ) );
  }
POMP_Single_end(&omp_rd_334); }
POMP_Barrier_enter(&omp_rd_334);
#pragma omp barrier
POMP_Barrier_exit(&omp_rd_334);
POMP_Single_exit(&omp_rd_334);
#line 2045 "lu.c"
}
POMP_Barrier_enter(&omp_rd_329);
#pragma omp barrier
POMP_Barrier_exit(&omp_rd_329);
POMP_Parallel_end(&omp_rd_329); }
POMP_Parallel_join(&omp_rd_329);
#line 2046 "lu.c"
}
/*--------------------------------------------------------------------
--------------------------------------------------------------------*/
...
POMP_Parallel_fork(&omp_rd_335);
#line 2340 "lu.c"
#pragma omp parallel  POMP_DLIST_00335
{ POMP_Parallel_begin(&omp_rd_335);
#line 2341 "lu.c"
{
...
POMP_Barrier_enter(&omp_rd_336);
#pragma omp barrier
POMP_Barrier_exit(&omp_rd_336);
POMP_For_exit(&omp_rd_336);
#line 2374 "lu.c"
...
POMP_Barrier_enter(&omp_rd_337);
#pragma omp barrier
POMP_Barrier_exit(&omp_rd_337);
POMP_For_exit(&omp_rd_337);
#line 2401 "lu.c"
    

POMP_For_enter(&omp_rd_338);
#line 2403 "lu.c"
#pragma omp for   nowait
  for (j = jst; j <= jend; j++) {
    for (k = 1; k <= nz - 2; k++) {
...
POMP_Barrier_enter(&omp_rd_338);
#pragma omp barrier
POMP_Barrier_exit(&omp_rd_338);
POMP_For_exit(&omp_rd_338);
#line 2511 "lu.c"
...
POMP_Barrier_enter(&omp_rd_339);
#pragma omp barrier
POMP_Barrier_exit(&omp_rd_339);
POMP_For_exit(&omp_rd_339);
#line 2538 "lu.c"

POMP_For_enter(&omp_rd_340);
#line 2539 "lu.c"
#pragma omp for   nowait
  for (i = ist; i <= iend; i++) {
    for (k = 1; k <= nz - 2; k++) {
...
POMP_Barrier_enter(&omp_rd_340);
#pragma omp barrier
POMP_Barrier_exit(&omp_rd_340);
POMP_For_exit(&omp_rd_340);
#line 2649 "lu.c"

/*--------------------------------------------------------------------
c   zeta-direction flux differences
--------------------------------------------------------------------*/
POMP_For_enter(&omp_rd_341);
#line 2653 "lu.c"
#pragma omp for   nowait
  for (i = ist; i <= iend; i++) {
    for (j = jst; j <= jend; j++) {
...
POMP_Barrier_enter(&omp_rd_341);
#pragma omp barrier
POMP_Barrier_exit(&omp_rd_341);
POMP_For_exit(&omp_rd_341);
#line 2770 "lu.c"
}
POMP_Barrier_enter(&omp_rd_335);
#pragma omp barrier
POMP_Barrier_exit(&omp_rd_335);
POMP_Parallel_end(&omp_rd_335); }
POMP_Parallel_join(&omp_rd_335);
#line 2771 "lu.c"
...
POMP_Parallel_fork(&omp_rd_342);
#line 2779 "lu.c"
#pragma omp parallel POMP_DLIST_00342
{ POMP_Parallel_begin(&omp_rd_342);
#line 2780 "lu.c"
{
...
POMP_Barrier_enter(&omp_rd_343);
#pragma omp barrier
POMP_Barrier_exit(&omp_rd_343);
POMP_For_exit(&omp_rd_343);
#line 2804 "lu.c"

/*--------------------------------------------------------------------
c   set the dependent variable values along north and south faces
--------------------------------------------------------------------*/
POMP_For_enter(&omp_rd_344);
#line 2808 "lu.c"
#pragma omp for nowait
  for (i = 0; i < nx; i++) {
    iglob = i;
...
POMP_Barrier_enter(&omp_rd_344);
#pragma omp barrier
POMP_Barrier_exit(&omp_rd_344);
POMP_For_exit(&omp_rd_344);
#line 2815 "lu.c"

POMP_For_enter(&omp_rd_345);
#line 2816 "lu.c"
#pragma omp for nowait
  for (i = 0; i < nx; i++) {
    iglob = i;
...
POMP_Barrier_enter(&omp_rd_345);
#pragma omp barrier
POMP_Barrier_exit(&omp_rd_345);
POMP_For_exit(&omp_rd_345);
#line 2823 "lu.c"

/*--------------------------------------------------------------------
c   set the dependent variable values along east and west faces
--------------------------------------------------------------------*/
POMP_For_enter(&omp_rd_346);
#line 2827 "lu.c"
#pragma omp for nowait
  for (j = 0; j < ny; j++) {
    jglob = j;
...
POMP_Barrier_enter(&omp_rd_346);
#pragma omp barrier
POMP_Barrier_exit(&omp_rd_346);
POMP_For_exit(&omp_rd_346);
#line 2834 "lu.c"

POMP_For_enter(&omp_rd_347);
#line 2835 "lu.c"
#pragma omp for nowait
  for (j = 0; j < ny; j++) {
    jglob = j;
...
POMP_Barrier_enter(&omp_rd_347);
#pragma omp barrier
POMP_Barrier_exit(&omp_rd_347);
POMP_For_exit(&omp_rd_347);
#line 2842 "lu.c"
}
POMP_Barrier_enter(&omp_rd_342);
#pragma omp barrier
POMP_Barrier_exit(&omp_rd_342);
POMP_Parallel_end(&omp_rd_342); }
POMP_Parallel_join(&omp_rd_342);
#line 2843 "lu.c"
...
POMP_Parallel_fork(&omp_rd_348);
#line 2995 "lu.c"
#pragma omp parallel POMP_DLIST_00348
{ POMP_Parallel_begin(&omp_rd_348);
#line 2996 "lu.c"
{
/*--------------------------------------------------------------------
c
...
POMP_Barrier_enter(&omp_rd_349);
#pragma omp barrier
POMP_Barrier_exit(&omp_rd_349);
POMP_For_exit(&omp_rd_349);
#line 3048 "lu.c"
}
POMP_Barrier_enter(&omp_rd_348);
#pragma omp barrier
POMP_Barrier_exit(&omp_rd_348);
POMP_Parallel_end(&omp_rd_348); }
POMP_Parallel_join(&omp_rd_348);
#line 3049 "lu.c"
}
/*--------------------------------------------------------------------
--------------------------------------------------------------------*/
...
--------------------------------------------------------------------*/
POMP_Parallel_fork(&omp_rd_350);
#line 3077 "lu.c"
#pragma omp parallel private(i,j,k,m) POMP_DLIST_00350
{ POMP_Parallel_begin(&omp_rd_350);
#line 3078 "lu.c"
{
POMP_For_enter(&omp_rd_351);
#line 3079 "lu.c"
#pragma omp for     nowait
  for (i = 0; i < ISIZ1; i++) {
    for (j = 0; j < ISIZ2; j++) {
...
POMP_Barrier_enter(&omp_rd_351);
#pragma omp barrier
POMP_Barrier_exit(&omp_rd_351);
POMP_For_exit(&omp_rd_351);
#line 3092 "lu.c"
}
POMP_Barrier_enter(&omp_rd_350);
#pragma omp barrier
POMP_Barrier_exit(&omp_rd_350);
POMP_Parallel_end(&omp_rd_350); }
POMP_Parallel_join(&omp_rd_350);
#line 3093 "lu.c"
/*--------------------------------------------------------------------
...
#line 3117 "lu.c"
#pragma omp master	
{ POMP_Master_begin(&omp_rd_352);
#line 3118 "lu.c"
      printf(" Time step %4d\n", istep);
POMP_Master_end(&omp_rd_352); }
#line 3119 "lu.c"
    }

POMP_Parallel_fork(&omp_rd_353);
#line 3121 "lu.c"
#pragma omp parallel private(istep,i,j,k,m) POMP_DLIST_00353
{ POMP_Parallel_begin(&omp_rd_353);
#line 3122 "lu.c"
{  
...
POMP_Barrier_enter(&omp_rd_354);
#pragma omp barrier
POMP_Barrier_exit(&omp_rd_354);
POMP_For_exit(&omp_rd_354);
#line 3137 "lu.c"
...
POMP_Barrier_enter(&omp_rd_355);
#line 3155 "lu.c"
#pragma omp barrier
POMP_Barrier_exit(&omp_rd_355);
#line 3156 "lu.c"
...
POMP_Barrier_enter(&omp_rd_356);
#line 3173 "lu.c"
#pragma omp barrier 
POMP_Barrier_exit(&omp_rd_356);
#line 3174 "lu.c"
...
POMP_Barrier_enter(&omp_rd_357);
#pragma omp barrier
POMP_Barrier_exit(&omp_rd_357);
POMP_For_exit(&omp_rd_357);
#line 3190 "lu.c"
}
POMP_Barrier_enter(&omp_rd_353);
#pragma omp barrier
POMP_Barrier_exit(&omp_rd_353);
POMP_Parallel_end(&omp_rd_353); }
POMP_Parallel_join(&omp_rd_353);
#line 3190 "lu.c"
  /* end parallel */
/*--------------------------------------------------------------------
